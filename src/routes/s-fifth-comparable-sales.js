...
export async function renderSFifthComparableSalesExperiment(propertySwitcherContext = {}) {
  return renderComparisonExperiment(propertySwitcherContext, {
    ...
    subtitle: "1301 S 5th Comparable Sales Experiment. This page demonstrates how a property owner might review nearby sales and similar properties using public records and comparable-sale screening techniques.",
    contextKicker: "Guided Comparable Search",
    introTitle: "A walkthrough for understanding comparison",
    introCopy: "The goal is not to determine market value. The goal is to understand how the subject property compares with nearby homes and recent sales.",
    disclaimer: "Comparable selection is often about finding the best available candidates rather than perfect matches. This walkthrough is neutral: it is meant to show the process, not to prove a result.",
